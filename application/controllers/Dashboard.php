...
class Dashboard extends CI_Controller {
    ...
    public function index() {
        ...
        if($this->session->userdata('client')['role_id'] == 4) {
            ...
            // Fetch All Review Doctor Wise
            $data['review_list']=$this->Rfp_model->get_user_rating($this->session->userdata('client')['id']);
            //pr($data['review_list'],1);
            $data['subview']="front/doctor_review_dashboard";
