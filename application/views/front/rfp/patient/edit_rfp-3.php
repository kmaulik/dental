			...
			<div class="row">
				<div class="col-md-12 col-sm-12">	
					<div class="form-group">
						...
						<textarea name="insurance_provider" class="form-control" placeholder="Enter Insurance Provider"><?php echo (isset($record['insurance_provider'])? $record['insurance_provider'] : set_value('insurance_provider')); ?></textarea>
					</div>
			...
			<div class="row">
				<div class="col-md-12 col-sm-12">
					<div class="form-group">
						...
						<input type="text" name="treatment_plan_total" class="form-control NumbersAndDot" placeholder="Treatment Plan Total" value="<?php echo (isset($record['treatment_plan_total'])? $record['treatment_plan_total'] : set_value('treatment_plan_total')); ?>" >
					</div>
