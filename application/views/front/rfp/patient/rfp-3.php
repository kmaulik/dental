			...
			<div class="row">
				<div class="col-md-12 col-sm-12">	
					<div class="form-group">
						...
						<textarea name="insurance_provider" class="form-control" placeholder="Enter Insurance Provider"><?=set_value('insurance_provider');?></textarea>
					</div>
			...
			<div class="row">
				<div class="col-md-12 col-sm-12">
					<div class="form-group">
						...
						<input type="text" name="treatment_plan_total" class="form-control NumbersAndDot" placeholder="Treatment Plan Total" value="<?=set_value('treatment_plan_total');?>" >
					</div>
