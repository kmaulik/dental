    ...
    <!-- content area -->
        ...
        <div class="panel panel-flat">
            <div class="panel-heading text-right">
                <a href="<?php echo site_url('admin/promotional_code/add'); ?>" class="btn btn-success btn-labeled"><b><i class=" icon-plus-circle2"></i></b> Add New Promotional Code</a>
            </div>
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        if (full.is_blocked == '0') {
                            ...
                            action += '&nbsp;&nbsp;<a href="<?php echo base_url(); ?>admin/promotional_code/action/block/' + id + '" class="btn border-warning text-warning-600 btn-flat btn-icon btn-rounded"  title="Block"><i class="icon-blocked"></i></a>'
                            ...
                            action += '&nbsp;&nbsp;<a href="<?php echo base_url(); ?>admin/promotional_code/action/activate/' + id + '" class="btn border-success text-success-600 btn-flat btn-icon btn-rounded"  title="Unblock"><i class="icon-checkmark-circle"></i></a>'
                            action += '&nbsp;&nbsp;<a href="<?php echo base_url(); ?>admin/promotional_code/action/delete/' + id + '" class="btn border-danger text-danger-600 btn-flat btn-icon btn-rounded btn_delete" title="Delete"><i class="icon-cross2"></i></a>'
                        }
                        return action;
                    }
