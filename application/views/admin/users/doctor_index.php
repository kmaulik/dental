                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        if (full.is_blocked == 0) {
                            action += '&nbsp;&nbsp;<a href="<?php echo base_url(); ?>admin/doctor/block/' + id + '" class="btn border-warning text-warning-600 btn-flat btn-icon btn-rounded"  title="Block"><i class="icon-blocked"></i></a>';
                        } else if (full.is_blocked == 1) {
                            action += '&nbsp;&nbsp;<a href="<?php echo base_url(); ?>admin/doctor/activate/' + id + '" class="btn border-success text-success-600 btn-flat btn-icon btn-rounded"  title="Unblock"><i class="icon-checkmark-circle"></i></a>';
                        }
