...
<div class="page-header page-header-default">
    <div class="page-header-content">
        <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Admin</span> - Manual Transaction List</h4>
        </div>
    </div>
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            <li><a href="<?php echo base_url() . "admin/dashboard" ?>"><i class="icon-home2 position-left"></i> Admin</a></li>
            <li>Manual Transaction List</li>
        </ul>
    </div>
</div>
<!-- /page header -->
...
<div class="content">
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-heading text-right">
            <form action="<?=base_url('admin/payment_transaction/manual_export_csv')?>" name="export_csv_frm" id="export_csv_frm" method="post">
    ...
    var table = $('.datatable-basic').dataTable({
        ...
        // },
        {
            ...
            render: function (data, type, full, meta) {
                var action = '';
                if(full.status == 0) {
                    action += '<span class="label label-danger">Manual</span>';  
                }else{
                    action += '<span class="label label-success">Manual</span>'; 
                }
                return action;
            }
        ...
        },
        {
        ...
        },
         {
            ...
            render: function (data, type, full, meta) {
                var action = '';
                var id= encodeURIComponent(btoa(full.payment_id));
                if (full.status == '0') {
                   action += '<a href="<?php echo base_url(); ?>admin/payment_transaction/manual_action/confirm_payment/' + id + '" class="btn border-success text-success-600 btn-flat btn-icon btn-rounded btn_confirm" title="Confirm Payment"><i class="icon-check"></i></a>'
                } 
                return action;
            }
        },
...
$(document).on( "click",".btn_confirm", function(e) {    
        ...
        bootbox.confirm('Are you sure to confirm the payment?',function(res){
            if (res) {
